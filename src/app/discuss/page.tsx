              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-10 animate-slide-in">
                  ...
                  <div className="flex flex-col sm:flex-row gap-5">
                    <Link href="/contact" className="group relative px-10 py-5 bg-primary text-white rounded-2xl font-black text-xl shadow-[0_20px_50px_rgba(var(--color-primary-rgb),0.3)] hover:shadow-[0_20px_60px_rgba(var(--color-primary-rgb),0.4)] transition-all duration-500 hover:-translate-y-2 flex items-center justify-center gap-3">
                      Start Discussion
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 animate-fade-in">
                  {points.map((point, i) => (
                    <div
                      key={point.title}
                      className="group p-8 rounded-[2rem] border border-border shadow-[0_20px_40px_rgba(0,0,0,0.03)] hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"

      ...
      <main className="flex-1">
        <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 overflow-hidden min-h-screen">
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div
              className="absolute bottom-[-10%] left-[-5%] w-[600px] h-[600px] bg-primary/10 rounded-full blur-[120px] animate-pulse"
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center w-full">
                <div className="space-y-10 animate-slide-in text-center lg:text-left flex flex-col items-center lg:items-start w-full">
                  ...
                  <p className="text-xl lg:text-2xl text-muted-foreground font-medium leading-relaxed max-w-xl">
                    Sustainable business growth comes from combining strategic vision with
                    intelligent, data-driven systems. Let&apos;s engineer your future.
                  </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 animate-fade-in w-full">
                  {points.map((point, i) => (
                    ...
                    >
                      <div
                        className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${point.gradient} flex items-center justify-center mb-6 shadow-xl ${point.shadow} group-hover:scale-110 transition-transform`}
                      >
          ...
          <div className="w-full px-6 lg:px-12">
            <div className="max-w-[1400px] mx-auto">
              <div className="relative p-12 lg:p-20 rounded-[4rem] bg-gradient-to-br from-background/[0.05] to-transparent border border-background/10 overflow-hidden text-center">
                ...
                <h2 className="text-4xl lg:text-6xl font-black text-background mb-8">

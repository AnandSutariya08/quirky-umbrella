...
export const metadata: Metadata = {
  ...
  description: 'Learn about Quirky Umbrella - our mission, values, and the team dedicated to transforming brands with innovative solutions.',
};
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-muted-foreground mb-8">
                ...
                forward-thinking company dedicated to transforming brands and delivering 
              ...
              <section className="mb-12">
                ...
                <p className="text-muted-foreground mb-4">
                  Our mission is to blend creativity with strategy, delivering exceptional 
                  branding solutions that make businesses stand out in today's competitive 
                  landscape. We believe in the power of innovation and the importance of 
              ...
              <section className="mb-12">
                ...
                <p className="text-muted-foreground mb-4">
                  With over 15 years of experience, 500+ completed projects, and a presence 
                  in 50+ countries, we have the expertise and global reach to help your 
                  business succeed. Our team of dedicated professionals is committed to 

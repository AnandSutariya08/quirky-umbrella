    ...
    <div className="relative min-h-screen font-body">
      ...
      <section className="relative z-10 pt-32 md:pt-40 pb-20 md:pb-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl">
          ...
          {/* Hero Image */}
          {service.imageUrl && (
            <div className="relative w-full max-w-5xl mx-auto rounded-3xl overflow-hidden group">
              <img
                src={service.imageUrl}
                alt={service.title}
            ...
            <div className="lg:col-span-8 space-y-20 md:space-y-32">
              ...
              <article className="space-y-6">
                <div className="flex items-baseline gap-4 pb-6 border-b-2 border-primary">
                  <span className="text-6xl md:text-7xl font-black font-heading text-primary/20">
                    01
                  </span>
              ...
              <article className="space-y-8">
                <div className="flex items-baseline gap-4 pb-6 border-b-2 border-secondary">
                  <span className="text-6xl md:text-7xl font-black font-heading text-secondary/20">
                    02
                  </span>
                  <h2 className="text-3xl md:text-4xl lg:text-5xl font-black font-heading text-foreground tracking-tight">
              ...
              <article className="space-y-8">
                <div className="flex items-baseline gap-4 pb-6 border-b-2 border-accent">
                  <span className="text-6xl md:text-7xl font-black font-heading text-accent/20">
                    03
                  </span>
                  <h2 className="text-3xl md:text-4xl lg:text-5xl font-black font-heading text-foreground tracking-tight">
                    {service.useCases.title}
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  {service.useCases.industries.map((industry, index) => (
                    <div
                      key={index}
                      className="bg-card rounded-3xl p-8 border-2 border-border hover:border-secondary/50 hover:shadow-xl hover:shadow-secondary/5 transition-all duration-500"
                    >
            ...
            <aside className="lg:col-span-4">
              <div className="lg:sticky lg:top-32 space-y-8">
                  ...
                  <div className="space-y-4 mb-8 relative z-10">
                    ...
                    <div className="space-y-3">
                      {service.approach.processSteps.map((step, index) => (
                        <div
                          key={index}
                          className="flex items-center gap-3 p-3 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all"
                        >
                ...
                <div className="p-8 rounded-3xl bg-accent/10 border-2 border-accent/20 hover:border-accent/40 transition-all">
                  ...
                  <Link
                    href="/book-meeting"
                    className="text-primary font-black flex items-center gap-2 hover:gap-3 transition-all group"
                  >
      ...
      <section className="py-24 md:py-40 bg-foreground text-background relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div
            className="absolute inset-0 bg-gradient-to-br from-primary via-secondary to-accent animate-gradient-pan"
